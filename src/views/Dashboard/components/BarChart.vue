          ...
          feature: {
            myTimeChange: {
              ...
              onclick: () => {
                ...
                if (this.time === "today") {
                  this.option.toolbox.feature.myTimeChange.title = "切换为全部";
                  this.option.title.text = "今日最受欢迎的十篇文章";
                  params.time = this.time;
                  this.time = "all";
                } else {
                  this.option.toolbox.feature.myTimeChange.title = "切换为今天";
                  this.option.title.text = "最受欢迎的十篇文章";
                  this.time = "today";
                }
                this.$ws.send(params);
              },
